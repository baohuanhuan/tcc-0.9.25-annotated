...
int total_bytes;
/* parser */
static struct BufferedFile *file;   /* 当前解析的字节流 */
static int ch;
static int tok;
static CValue tokc;
...
#define TOK_FLAG_BOL   0x0001 /* beginning of line before */        /* token起始于一行的开始处 */
#define TOK_FLAG_BOF   0x0002 /* beginning of file before */        /* token起始于文件的起始处 */
#define TOK_FLAG_ENDIF 0x0004 /* a endif was found matching starting #ifdef */
#define TOK_FLAG_EOF   0x0008 /* end of file */                     /* 文件结束 */

static int *macro_ptr, *macro_ptr_allocated;
static int *unget_saved_macro_ptr;
static int unget_saved_buffer[TOK_MAX_SIZE + 1];                    /* 保存退回的token列表 */
